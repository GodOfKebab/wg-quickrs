...
async fn main() -> ExitCode {
    ...
    match &args.command {
        cli::Commands::Init {
            ...
            agent_local_web_port.clone(),
            agent_local_vpn_port.clone(),
            agent_public_address.clone(),
            agent_public_vpn_port.clone(),
            agent_internal_vpn_address.clone(),
            agent_use_tls.clone(),
            agent_enable_web_password.clone(),
            agent_web_password.clone(),
            agent_enable_dns.clone(),
            agent_dns_server.clone(),
            agent_enable_mtu.clone(),
            agent_mtu_value.clone(),
            agent_enable_script_pre_up.clone(),
            agent_script_pre_up_line.clone(),
            agent_enable_script_post_up.clone(),
            agent_script_post_up_line.clone(),
            agent_enable_script_pre_down.clone(),
            agent_script_pre_down_line.clone(),
            agent_enable_script_post_down.clone(),
            agent_script_post_down_line.clone(),
            default_enable_dns.clone(),
            default_dns_server.clone(),
            default_enable_mtu.clone(),
            default_mtu_value.clone(),
            default_enable_script_pre_up.clone(),
            default_script_pre_up_line.clone(),
            default_enable_script_post_up.clone(),
            default_script_post_up_line.clone(),
            default_enable_script_pre_down.clone(),
            default_script_pre_down_line.clone(),
            default_enable_script_post_down.clone(),
            default_script_post_down_line.clone(),
            default_enable_persistent_keepalive.clone(),
