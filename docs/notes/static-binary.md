...
`wg-quickrs` is a Rust-based replacement for `wg-quick` that executes the same underlying commands, 
...
<p align="center">
  <img src="wg-quickrs.drawio.png" alt="wg-quickrs architecture diagram">
</p>
