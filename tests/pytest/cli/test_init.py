...
@pytest.mark.parametrize(
    ...
    [
        ...
        # Verify that without h-random, h values are still required
        ("agent_vpn", "--agent-vpn-wg $(which awg) --agent-vpn-wg-userspace-enabled false --network-amnezia-enabled true --network-amnezia-s1 56 --network-amnezia-s2 156 --agent-peer-amnezia-jc 3 --agent-peer-amnezia-jmin 61 --agent-peer-amnezia-jmax 121 --default-peer-amnezia-jc 3 --default-peer-amnezia-jmin 61 --default-peer-amnezia-jmax 121", False),
    ],
)
