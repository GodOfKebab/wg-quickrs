...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("network.peers.0ed989c6-6dba-4e3c-8034-08adf4262d9e.endpoint", {"enabled": True, "address": "invalid-address", "port": 51820}, ["ipv4"]),
        ...
        ("network.defaults.peer.endpoint", {"enabled": True, "address": "invalid-address", "port": 51820}, ["ipv4"]),
